...
/**
 * Top rated loads the details from the API for movies in cinemas.
...
class TopRated extends React.Component {
   ...
   */
  componentDidMount() {
    const url = ("https://api.themoviedb.org/3/movie/top_rated?api_key=5952fca5b680beeeeb34acf859935418&language=en-US&page=" + (this.state.page));
  ...
  /**
   * When the next button is pressed the next page of movies is loaded.
   */
  handleNextClick = () => {
    this.setState({ page: this.state.page + 1 }, () => {
      const url = ("https://api.themoviedb.org/3/movie/top_rated?api_key=5952fca5b680beeeeb34acf859935418&language=en-US&page=" + (this.state.page))
